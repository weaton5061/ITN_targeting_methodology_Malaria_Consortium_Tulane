...
```{r}
# Explore color palette ---
# run this code if you would like to inspect some color options
# palette_explorer()
```
...
# database of country administrative areas, with a goal of “all countries, 
...
# unable to find an inherited method for function ‘exact_extract’ for signature
...
#* ---------------------------------------------------------------------------
#* From: PRESIDENT’S MALARIA INITIATIVE NIGERIA 
...
# --------------------------------------------------------------------------
# 1b) Create Equally weighted Priortization/Malaria Risk map ---------------
# Status: complete on 7-21-20
